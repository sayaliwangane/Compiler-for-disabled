...
while True:
    ...
    #          'six': len(os.listdir(directory+"/6")),
             ...
             'print': len(os.listdir(directory+"/print")),
             '(': len(os.listdir(directory+"/(")),
             'HelloWorld': len(os.listdir(directory+"/HelloWorld")),
             ')': len(os.listdir(directory+"/)"))
}
    ...
    cv2.putText(frame, "print : "+str(count['print']), (10, 360), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "( : "+str(count['(']), (10, 370), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "HelloWorld : "+str(count['HelloWorld']), (10, 380), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, ") : "+str(count[')']), (10, 390), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
...
#    _, roi = cv2.threshold(roi, 120, 255, cv2.THRESH_BINARY)
    ...
    if interrupt & 0xFF == ord('='):
        cv2.imwrite(directory+'print/'+str(count['print'])+'.jpg', roi)        
    if interrupt & 0xFF == ord('-'):
        cv2.imwrite(directory+'(/'+str(count['('])+'.jpg', roi)
    if interrupt & 0xFF == ord('4'):
        cv2.imwrite(directory+'HelloWorld/'+str(count['HelloWorld'])+'.jpg', roi)        
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+')/'+str(count[')'])+'.jpg', roi)        
